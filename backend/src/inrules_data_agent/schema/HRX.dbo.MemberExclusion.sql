...
(
    [Memid] char(15) NOT NULL, -- Member Identifier within pharmacy benefits system | PK marker: X
    [Type] varchar(15) NOT NULL, -- Pharmacy attribute used in claims, PA, pricing, or drug reference processing | PK marker: X
    [Value] varchar(15) NOT NULL, -- Value specified by member type | PK marker: X
    [EffDate] smalldatetime NOT NULL, -- Date and time the record becomes inactive | PK marker: X
    ...
    [CreateBy] varchar(15) NOT NULL, -- User who created the record
    [ChangedDate] smalldatetime NOT NULL, -- Date and time the record was changed
    [ChangedBy] varchar(15) NOT NULL, -- User who changed the record
    [Notes] varchar(2000) NULL, -- Long description comment, including date timestamp and user ID of when record was inserted
